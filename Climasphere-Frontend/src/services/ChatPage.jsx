...
const ChatPage = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-between mt-[0.7rem] pl-[0.9rem] pr-[0.9rem] bg-slate-950 min-h-screen">
      ...
      >
        ...
        <div
          className="w-9 h-9 flex items-center justify-center rounded-xl
                   ...
                   hover:text-orange-400 hover:border-slate-600 transition-colors"
          onClick={(e) => {
            e.stopPropagation();
            ...
            {messages.map((msg, index) => (
              ...
              >
                ...
                >
                  ...
                  {msg.message && (
                    <div
                      className={`text-sm px-4 py-2 rounded-2xl min-w-[80px]
            ...
            <div className="relative flex items-center h-[4rem] gap-2 px-1">
              {file && (
                <div className="flex items-center gap-2 p-2 bg-slate-800 border border-slate-700
                  ...
                  <span className="truncate text-sm text-slate-300 max-w-[8rem]">{file.name}</span>
                  <button onClick={() => { setFile(null); setFilePreview(null); }}>
                    <FiX size={18} className="text-slate-500 hover:text-red-400 transition-colors" />
                  </button>
                </div>
              )}
              ...
              <textarea
                ...
                className="flex-1 bg-slate-800 border border-slate-700 text-slate-100
                         placeholder-slate-500 rounded-2xl px-4 py-3 text-sm resize-none
                         outline-none focus:border-slate-500 transition-colors leading-normal"
                rows={1}
